...
function checkSubmit() {
    ...
    if (pwdFormatCheck(CPassword) && pwdFormatCheck(RPassword)) {
        ...
        document.getElementById("warning").innerHTML = "Error: mal formato de la contraseña, vuelva a intentarlo";
    }
...
function SendChangeRequest() {
    ...
    var url = "http://3587b861185a.ngrok.io/api/v1/accSettings/restorePasswordReception/";
    ...
    if (CPassword == RPassword) {
        ...
        http.onreadystatechange = function() {
            if(http.readyState == 4 && http.status == 200) { 
                ...
                document.getElementById("main_container").innerHTML = "Ha habido un error en el envío de la solicitud. Por favor, vuelva a intentarlo";
        }
        console.log(str);
